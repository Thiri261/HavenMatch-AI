  ...
  return (
    <footer className="site-footer">
      <div className="footer-main">
        ...
        <nav aria-label="Account"><h2>Account</h2>{session ? <><a href="#dashboard">My dashboard</a><a href="#dashboard-favourites">Saved favourites</a><button type="button" onClick={logOut}>Log out</button></> : <><a href="#signin">Log in</a><a href="#signup">Create an account</a></>}</nav>
      </div>
